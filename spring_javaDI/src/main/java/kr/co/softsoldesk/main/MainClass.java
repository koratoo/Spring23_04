...
//		System.out.println("xml22 : " + xml22);
		System.out.println("scope가 protype일때");
		...
		System.out.println("primary true일때 클래스 중복시 사용하여 정상값 가져오기");
		...
		System.out.println();
//		System.out.println("메서드 이름으로 객체 받기");
...
//		System.out.println("java600" + java600);
		System.out.println();
		System.out.println("lazy-init 값이 true...");
