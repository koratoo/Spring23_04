...
public class MainClass4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" [생성자 매개변수 4개 주입을 이용] ");
		...
		System.out.println(" [생성자 4개 자동 주입을 이용] ");
		...
		System.out.println("obj8.data3 : " + obj8.getData1());
		System.out.println("obj8.data4 : " + obj8.getData2());
		
		System.out.println(" [default-autowire 미사용] ");
		TestBean1 obj9 = ctx.getBean("obj9",TestBean1.class);
		System.out.println("obj9.data3 : " + obj9.getData1());
		System.out.println("obj9.data4 : " + obj9.getData2());
		ctx.close();
	}
}
